  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: bg }]} contentContainerStyle={styles.content}>
      ...
      <View style={[styles.card, { backgroundColor: cardBg }]}>
        ...
        <ToggleRow label="Messages" subtitle="Notifications for new messages" value={messageEnabled} onToggle={toggleMessages} textColor={textColor} subtextColor={subtextColor} tint={tint} />
